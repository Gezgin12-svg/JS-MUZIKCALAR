...
//şarkı sıra
let index;
//şarkı başa sarsın mı sarmasın mı
let loop = true;
//şarkı listesi :şarkıcı resmi şarkı adı şarkıcı gibi değişkenleri tanımladık
const songsList = [
  {
    name: "Gelo Ew Ki Bu",
...
//zamanı dk/sn cinsinden yazdırma
...
//önceki şarkı için fonksiyon tanımladım
const previousSong = () => {
  if (index > 0) {
    index = index - 1;
  } else {
...
//sıradakine tıkllama(içn fonksiyon çalıştrdım)
nextButton.addEventListener("click", nextSong);

//önceki tıklama(içn fonksiyon çalıştrdım)
prevButton.addEventListener("click", previousSong);

//döngü butonuna tıklanılırsa
